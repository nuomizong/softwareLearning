...
\begin{center}
  ...
  \end{figure}
   \vspace*{55pt}
   {\centering\hei\erhao\bf{本科生毕业论文任务书}}
...
\newpage
\defaultfont
\par\song\sihao{一、原始依据（包括论文的工作基础、研究条件、应用环境、工作目的等。）}
\song\xiaosi{}
\vspace*{225pt}
...
\thispagestyle{empty}
\newpage
\par\song\sihao{三、研究内容和要求（包括研究内容、主要指标与技术参数，并根据课题性质对学生提出具体要求。）}
\song\xiaosi{}
\vfill
...
%%%%%%%%%%%%%%%%%%%  天津大学本科生毕业论文开题报告  %%%%%%%%%%%%%%%%%%%%%%%
\newpage
\markboth{天津大学本科生毕业论文开题报告}{天津大学本科生毕业论文开题报告}
\pdfbookmark[0]{天津大学本科生毕业论文开题报告}{creport}
\begin{center}
\hei\sanhao{天津大学本科生毕业论文开题报告}
\end{center}
\begin{table}[h]
  \centering\sihao
